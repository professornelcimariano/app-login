...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2 class="fs-2"><i class="bi bi-bar-chart-fill"></i> Cadastro de suplierros</h2>
                <hr>
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- <a href="<?= $base; ?>/admin/suplier/delete.php?id=<?= $id; ?>"> <i class="bi bi-trash" style="color: red;"></i> </a> -->
                                    <!-- Substitua o link de exclusão por um botão -->
                                    <button class="btn btn-danger m-2 btn-delete" data-id="<?= $id; ?>">Excluir</button>

                                    <a class="btn btn-primary m-2" href="<?= $base; ?>/admin/suplier/form-update.php?id=<?= $id; ?>"> Editar </a>
            ...
            button.addEventListener('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.location.href = base + '/admin/suplier/delete.php?id=' + itemId;
                    }
                });
            });
        });
